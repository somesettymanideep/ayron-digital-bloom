...
const faqs = [
  { q: "What services does Ayron Digital Solutions offer in Vijayawada & Guntur?", a: "We offer 8 core services in Vijayawada and Guntur: Digital Marketing, Website Design, Brand Identity, Email Marketing, Influencer Marketing, Ecommerce Listing, SEO Optimization, and Product Shoot — all designed to drive measurable growth for local and pan-India businesses.", cat: "Services" },
  ...
  { q: "What makes Ayron the best digital marketing agency in Vijayawada?", a: "Full-service capability, data-driven strategy, dedicated account managers, and transparent reporting. As the top agency in Vijayawada and Guntur, we don't just deliver reports — we deliver results you can measure.", cat: "Process" },
