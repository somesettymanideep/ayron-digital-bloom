...
const allBlogs = [
  ...
  },
  {
    ...
    excerpt: "Your brand is more than a logo. Discover the elements that make brands unforgettable.",
    date: "Dec 2025",
    author: "Team Ayron",
    readTime: "7 min read",
  },
  {
    ...
    title: "The Ultimate Guide to Performance Marketing for D2C Brands",
    excerpt: "Performance marketing can scale your D2C brand fast — if done right. Here's the playbook.",
    date: "Dec 2025",
    author: "Team Ayron",
    readTime: "8 min read",
  },
  {
    ...
    title: "How to Create a Social Media Content Calendar That Works",
    excerpt: "Stop posting randomly. A structured content calendar drives consistency and results.",
    date: "Nov 2025",
    author: "Team Ayron",
    readTime: "5 min read",
  },
  {
    category: "Ecommerce",
    title: "Amazon Listing Optimization: A Complete Seller's Guide",
    excerpt: "Your product listing is your storefront. Learn how to optimize every element for conversions.",
    date: "Nov 2025",
    author: "Team Ayron",
    readTime: "6 min read",
  },
  {
    ...
    excerpt: "Traffic without conversions is wasted money. Here are the top UX mistakes costing you sales.",
    date: "Oct 2025",
    author: "Team Ayron",
    readTime: "5 min read",
  },
  {
    category: "SEO",
    title: "Local SEO Strategies for Small Businesses in India",
    excerpt: "Dominate local search results with these proven strategies tailored for the Indian market.",
    date: "Oct 2025",
    author: "Team Ayron",
    readTime: "4 min read",
  },
